...
export const Footer: React.FC<FooterProps> = ({ onOpenAuth, onSelectCategory, siteSettings }) => {
  ...
  return (
    <footer className="bg-transparent border-t border-zinc-900 text-zinc-400 text-sm text-left">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-zinc-400 leading-relaxed mt-2 text-left">
              {about}
            </p>
            <div className="flex items-center gap-2 text-amber-500 font-mono font-bold pt-2">
            ...
            <div className="flex items-center gap-4 pt-2">
              {siteSettings?.socialInstagram && (
                <a href={siteSettings.socialInstagram} target="_blank" rel="noreferrer" className="text-zinc-400 hover:text-amber-500 transition-colors">
                  <Instagram className="w-5 h-5" />
                </a>
              )}
              {siteSettings?.socialYoutube && (
                <a href={siteSettings.socialYoutube} target="_blank" rel="noreferrer" className="text-zinc-400 hover:text-amber-500 transition-colors">
                  <Youtube className="w-5 h-5" />
                </a>
              )}
              {siteSettings?.socialFacebook && (
                <a href={siteSettings.socialFacebook} target="_blank" rel="noreferrer" className="text-zinc-400 hover:text-amber-500 transition-colors">
                  <Facebook className="w-5 h-5" />
                </a>
              )}
              {siteSettings?.socialTwitter && (
                <a href={siteSettings.socialTwitter} target="_blank" rel="noreferrer" className="text-zinc-400 hover:text-amber-500 transition-colors">
          ...
          <div className="space-y-3 text-left">
            ...
            <ul className="space-y-2">
              <li>
                <button onClick={() => onSelectCategory('Exhaust & Turbo')} className="hover:text-amber-500 transition-colors text-left">
                  Exhaust Systems & Turbochargers
                </button>
              </li>
              <li>
                <button onClick={() => onSelectCategory('Suspension & Brakes')} className="hover:text-amber-500 transition-colors text-left">
                  Coilovers & Monoblock Caliper Brakes
                </button>
              </li>
              <li>
                <button onClick={() => onSelectCategory('Interior & Seats')} className="hover:text-amber-500 transition-colors text-left">
                  BRIDE Seats & TAKATA Harnesses
                </button>
              </li>
              <li>
                <button onClick={() => onSelectCategory('Wheels & Tires')} className="hover:text-amber-500 transition-colors text-left">
          ...
          <div className="space-y-3 text-left">
            ...
            <div className="space-y-2 text-zinc-400 text-left">
            ...
            <div className="pt-2 text-left">
              <button
                onClick={onOpenAuth}
                className="inline-flex items-center gap-1.5 text-zinc-400 hover:text-amber-500 font-mono text-[12px] border-b border-zinc-800 pb-0.5"
              >
        ...
        <div className="mt-12 pt-8 border-t border-zinc-900 flex flex-col sm:flex-row items-center justify-between text-[12px] text-zinc-500 gap-4">
          <p>{copyright}</p>
